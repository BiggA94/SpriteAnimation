...
public class SpriteHandlerTest {
	...
	/**
	 * Width of Line that Separates the images
	 */
	private int separationWidth = 1;
	/**
	 * Height of Line that Separates the images
	 */
	private int separationHeight = 1;
	/**
	...
	public void initializeTest() {
		handler = new SpriteHandler<ZFAnimation>(offsetX, offsetY, rowCount, columnCount, separationWidth, separationHeight, width, heigth);
	}
